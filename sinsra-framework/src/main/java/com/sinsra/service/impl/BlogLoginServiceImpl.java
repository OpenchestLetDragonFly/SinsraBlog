...
import com.sinsra.util.JwtUtils;
import com.sinsra.util.RedisCache;
import com.sinsra.domain.vo.BlogUserLoginVo;
...
public class BlogLoginServiceImpl implements BlogLoginService {
    ...
    @Autowired
    //RedisCache是我们在sinsra-framework工程的config目录写的类
    ...
    public ResponseResult login(User user) {
        ...
        //在下一行之前，封装的数据会先走UserDetailsServiceImpl实现类，这个实现类在我们的sinsra-framework工程的service/impl目录里面
